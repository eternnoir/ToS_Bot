...
public class TosBoardProcesser implements IBoardProcesser {
	...
	public Bitmap cutBallReg(String FilePath) {
		_Path = FilePath;
		Bitmap sourceBitmap;
	...
	public int checkColor(Bitmap bm) {
		int ret = 0;
	...
	public void savePng(String Filename, Bitmap bm) {
		try {
	...
	public int checkBallColor(Bitmap bm) throws NotInTosException {
