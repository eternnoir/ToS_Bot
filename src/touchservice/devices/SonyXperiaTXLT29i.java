...
public class SonyXperiaTXLT29i extends AbstractTouchService {
	...
	public Vector<String> touchDown(int x, int y) {
		...
		cl.add("sendevent /dev/input/event0 3 53 " + x + "\n");
		cl.add("sendevent /dev/input/event0 3 54 " + y + "\n");
		cl.add("sendevent /dev/input/event0 3 58 105\n");
	...
	public Vector<String> touchMoveX(int x1, int x2, int gap) {
		Vector<String> cl = new Vector<String>();
		cl.add("sendevent /dev/input/event0 3 53 " + x2 + "\n");
		cl.add("sendevent /dev/input/event0 0 0 0 \n");
	...
	public Vector<String> touchMoveY(int y1, int y2, int gap) {
		Vector<String> cl = new Vector<String>();
		cl.add("sendevent /dev/input/event0 3 54 " + y2 + "\n");
		cl.add("sendevent /dev/input/event0 0 0 0 \n");
